...
const cancelDataSyncSelectionUI = document.getElementById("cancel-data-sync-selection-button");
let loginStatus;
...
let dataSync = "offline only";
if (loginStatus) {
    loginSectionUI.style.display = "none";
    // Because the user is logged in, the data
    let dataSyncSelectionString = localStorage.getItem("bytesized-journal-data-sync-selection");
