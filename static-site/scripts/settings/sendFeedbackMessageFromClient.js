...
const formNameUI = document.getElementById("feedback-form-name");
const formEmailUI = document.getElementById("feedback-form-email");
const formSubjectUI = document.getElementById("feedback-form-subject");
const formBodyUI = document.getElementById("feedback-form-message-body");
// The modal elements for display
const fieldsIncompleteModalUI = document.getElementById("fields-incomplete-modal");
const closeIncompleteModalButtonUI = document.getElementById("close-fields-incomplete-modal-button");
const serverErrorModalUI = document.getElementById("server-error-modal");
...
let redBorder = "0.1rem solid red";
let blackBorder = "0.1rem solid black";
/*
