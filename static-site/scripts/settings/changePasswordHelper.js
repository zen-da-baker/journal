...
const currentPasswordInputUI = document.getElementById("current-password");
const firstPasswordInputUI = document.getElementById("first-new-password");
const secondPasswordInputUI = document.getElementById("second-new-password");
