...
export function displayJournalEntry(entry) {
    ...
    // The modals 
    let newLineModalUI = document.getElementById("new-line-modal");
    let lineTypeSelectionUI = document.getElementById("line-type-selection");
    ...
    let newImageModalUI = document.getElementById("new-image-modal");
    let newImageSourceInputUI = document.getElementById("image-link-input");
    let newImageAltTextInputUI = document.getElementById("image-alt-text-input");
    ...
    let newLineErrorModalUI = document.getElementById("new-line-error-modal");
    let newYouTubeVideoModelUI = document.getElementById("new-youtube-video-modal");
    let newYouTubeVideoInputUI = document.getElementById("video-link-input");
    ...
    let editExistingImageModalUI = document.getElementById("edit-existing-image");
    let existingImageSourceInputUI = document.getElementById("image-source-edit-input");
    let existingAltTextInputUI = document.getElementById("image-alt-text-edit-input");
    ...
    let editVideoModalUI = document.getElementById("edit-existing-video");
    let editVideoLinkSourceInputUI = document.getElementById("edit-existing-video-source-input");
    ...
    entry.listOfLines.forEach((line, index) => {
        let newLine;
        if (line.type === "img") {
        ...
        newLine.onkeydown = (event) => {
            ...
            if (event.key === "Enter") {
                ...
                // A new line is created and the id of it is returned
                let newLineId = addNewLine(entry, index);
